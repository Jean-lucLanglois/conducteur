...
bool set_app_preferences(bool &engine_status, int &pull_interval, int &stock_count){
...
int main(int argc, const char * argv[]) {
    ...
    if (stock_count > 0) {  // make sure we have stocks to pull
